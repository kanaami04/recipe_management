...
func New(cfg *config.Config, db *gorm.DB, s3Client *s3.Client, mailer domain.Mailer, logger *slog.Logger) *echo.Echo {
	...
	services := service.New(repos.User, repos.Label, repos.Recipe, repos.ShoppingList, repos.ShareGroup, avatars, jwtManager, mailer, cfg.EmailVerifyURL, cfg.PasswordResetURL)
