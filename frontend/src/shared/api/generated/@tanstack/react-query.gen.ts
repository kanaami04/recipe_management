 ...
 */
export const addShoppingListItemsMutation = (options?: Partial<Options<AddShoppingListItemsData>>): UseMutationOptions<AddShoppingListItemsResponse, AxiosError<AddShoppingListItemsError>, Options<AddShoppingListItemsData>> => {
    const mutationOptions: UseMutationOptions<AddShoppingListItemsResponse, AxiosError<AddShoppingListItemsError>, Options<AddShoppingListItemsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await addShoppingListItems({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
